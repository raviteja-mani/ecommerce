...
import com.rvtjakula.resourceservice.services.CartService;
...
public class CartController {
	...
	public ResponseEntity<CartDTO> getCartById(@PathVariable String userId, @PathVariable Long cartId) {
